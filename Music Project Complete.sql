...
ANS
select billing_city as "City Name", sum(total) as "Total Invoice" from invoice 
...
sum(il.unit_price*il.quantity) as "Total of Invoice"  
from customer c 
join invoice i on c.customer_id = i.customer_id
join invoice_line il on il.invoice_id = i.invoice_id
join track t on t.track_id = il.track_id
join album al on al.album_id = t.album_id
join best_seller_artist bsa on bsa.artist_id = al.artist_id
group by 1,2,3,4
order by 5 desc
